    ...
    return (
        <>
            ...
            <div className="bg-customWhite p-10 md:p-20">
                    ...
                    <p className="text-customBlack mb-4">La società Sirion S.r.l., in attuazione della disciplina introdotta dal D. Lgs. n. 24/2023 (c.d. Decreto Whistleblowing), ha aggiornato la “Procedura riguardante la protezione delle persone che segnalano violazioni di diritto” (consultabile cliccando il seguente <Link  target="_blank"style={{textDecoration:'underline', color:'#004F92'}} href={'https://www.deltats.eu/wp-content/uploads/2024/04/PROCEDURA-DI-SEGNALAZIONE-DELTATS-1-3.pdf'}>link</Link> ), avente la finalità di permettere la rivelazione spontanea, da parte del segnalante, di condotte illecite rilevanti a fini della normativa in materia di whistleblowing di cui sia venuto a conoscenza nel contesto lavorativo della Società.</p>
                    <p className="text-customBlack mb-4">La procedura identifica le tipologie di violazioni e comportamenti illeciti e/o inopportuni che possono essere segnalate attraverso il canale Whistleblowing, nonché la piattaforma informatica a disposizione per effettuare la segnalazione raggiungibile al seguente <Link target="_blank" style={{textDecoration:'underline', color:'#004F92'}} href={'Sirion-informativa-privacy-whistleblowing.pdf'}>link</Link></p>
                    <p className="text-customBlack b-4">Per consultare l’informativa Privacy relativamente al Whistleblowing cliccare il <Link target="_blank" style={{textDecoration:'underline', color:'#004F92'}} href={'https://www.deltats.eu/wp-content/uploads/2024/04/whistleblowingPrivacy-DELTATS-1.pdf'}>link</Link></p>
